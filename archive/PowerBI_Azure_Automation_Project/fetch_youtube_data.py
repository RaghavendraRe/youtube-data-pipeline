...
# Configuration
API_KEY = "AIzaSyBM5DU838aPORBzQE7L3Hv1q7PVGSEQlGU"
CHANNEL_ID = "UCUDKhNE_Y_DVkFx1nFNZTWQ" # Bravo Kumaris
OUTPUT_FILE = "brahmakumaris_videos_v3.csv"
...
def get_video_details(video_ids, podcast_map):
    ...
    for item in data["items"]:
        ...
        record = {
            ...
            "Raw JSON Path": "N/A", 
            "First Fetched At": datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
            "Last Fetched At": datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        }
...
def main():
    try:
        print("Starting YouTube Data Collection with Podcast Mapping...")
